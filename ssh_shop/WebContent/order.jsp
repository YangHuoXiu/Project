			...
			<table>
				<tbody>
					...
					<s:iterator var="orderItem" value="model.orderItems">
						<tr>
							<td width="60">
							<img width="40" height="45" src="<s:property value="#orderItem.product.productInfor.image"/>"/>
							</td>
							<td><s:property value="#orderItem.product.pname" /></td>
							<td><s:property value="#orderItem.product.productInfor.price" /></td>
					...
					<p>
						...
						<table>
							<tbody>
								...
								<s:iterator var="user" value="user">
									<tr>
										<td><s:property value="#user.userInfor.address" /></td>
										<td><s:property value="#user.username" /></td>
										<td><s:property value="#user.userInfor.phone" /></td>
									</tr>
								</s:iterator>
							</tbody>
						</table>
