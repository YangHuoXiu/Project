	...
	<div class="container index">
			...
			<div id="hotProduct" class="hotProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach items="${list}" var="list">
						<li style="float: left"><a href="findByPid?pid=${list.pid }"><img
								src="${list.productInfor.image}"
								style="display: block; float: left"></a></li>
					</c:forEach>
				</ul>
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach items="${list}" var="list">
						<li style="float: left"><a href="findByImage"><img
								src="${list.productInfor.image}"
								style="display: block; float: left"></a></li>
					</c:forEach>
				</ul>
